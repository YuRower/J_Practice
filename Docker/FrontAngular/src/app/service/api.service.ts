...
export class ApiService {
  ...
  baseUrl: string = 'http://localhost:8888/Web_Services/rest/users/';


 login(loginPayload) : Observable<ApiResponse> {
    return this.http.post<ApiResponse>('http://localhost:8888/Web_Services/' + 'token/generate-token', loginPayload);
