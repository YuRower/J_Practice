...
public class JdbcRoleDaoTest extends DBUnitConfig {
    ...
    private static final String FULL_DATASET = "resources/dataset/RoleSet/full.xml";
    private static final String EMPTY_TABLE = "resources/dataset/RoleSet/empty.xml";
    ...
    public void testCreate() throws Exception {
        ...
        String afterCreate = "resources/dataset/RoleSet/RoleAfterCreate.xml";
    ...
    public void testUpdate() throws Exception {
        String afterUpdate = "resources/dataset/RoleSet/RoleAfterUpdate.xml";
        Role role = roles[1];
        role.setName("Admin1");
    ...
    public void testRemove() throws Exception {
        String afterRemove = "resources/dataset/RoleSet/RoleAfterRemove.xml";
