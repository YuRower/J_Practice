...
public class JdbcUserDaoTest extends DBUnitConfig {
    private static final String DATASET_COMMON = "resources/dataset/UserSet/full.xml";
    private static final String TABLE_EMPTY = "resources/dataset/UserSet/empty.xml";
    ...
    public void testCreate() throws DatabaseUnitException {
        ...
        String afterCreate = "resources/dataset/UserSet/UserAfterCreate.xml";
    ...
    public void testUpdate() throws DatabaseUnitException {
        String afterUpdate = "resources/dataset/UserSet/UserAfterUpdate.xml";
    ...
    public void testRemove() throws DatabaseUnitException {
        String afterRemove = "resources/dataset/UserSet/UserAfterRemove.xml";
